...
import { copyKey } from '../basedriver/helpers';
    ...
    try {
      ...
      if (driverRes) {
        if (currentProtocol === BaseDriver.DRIVER_PROTOCOL.W3C) {
          driverRes = copyKey(driverRes, MJSONWP_ELEMENT_KEY, W3C_ELEMENT_KEY);
        } else {
          driverRes = copyKey(driverRes, W3C_ELEMENT_KEY, MJSONWP_ELEMENT_KEY);
        }
      }
