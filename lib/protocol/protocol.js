...
import { errors, isErrorType, isUnknownError, errorFromMJSONWPStatusCode,
         errorFromW3CJsonCode, getResponseForW3CError,
         getResponseForJsonwpError } from './errors';
...
function buildHandler (app, method, path, spec, driver, isSessCmd) {
  let asyncHandler = async (req, res) => {
    ...
    try {
      ...
      } else if (!isW3C && isUnknownError(err)) {
