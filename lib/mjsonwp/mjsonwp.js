...
function checkParams (paramSets, jsonObj) {
  ...
  //c# client passes both locator and using for find action
  optionalParams.push('locator');
    
  //c# client passes this for sendKeys action    
  optionalParams.push('keysToSend');    
