...
const METHOD_MAP = {
  ...
  '/wd/hub/session/:sessionId/appium/viewport_screenshot': {
    GET: {command: 'getViewportScreenshot'}
  },
  '/wd/hub/session/:sessionId/appium/device/viewport_rect': {
    GET: { command: 'getViewportRect' }
  },
  '/wd/hub/session/:sessionId/appium/device/pixel_ratio': {
    GET: { command: 'getDevicePixelRatio' }
  },
  '/wd/hub/session/:sessionId/appium/element/:elementId/page_down': {
    GET: { command: 'pageDown' }
  },
  '/wd/hub/session/:sessionId/appium/element/:elementId/page_up': {
    GET: { command: 'pageUp' }
  },
  '/wd/hub/session/:sessionId/appium/device/stat_bar_height': {
      GET: {command: 'getStatusBarHeight'}
  },
  '/wd/hub/session/:sessionId/appium/element/:elementId/content_size': {
      GET: {command: 'getElementContentSize'}
  },
  '/wd/hub/session/:sessionId/appium/element/:elementId/first_visible': {
      GET: {command: 'getFirstVisible'}
  },
  '/wd/hub/session/:sessionId/appium/element/:elementId/scroll_to': {
      POST: {command: 'scrollToElement' }
  },
  '/wd/hub/session/:sessionId/appium/element/:elementId/scroll_inside/:top': {
      GET: { command: 'scrollInside' }
  },
