...
import ProtoConverter from './proto-converter';
...
class JWProxy {
  constructor (opts = {}) {
    ...
    this.protoConverter = new ProtoConverter(this.proxy.bind(this));
  }
  ...
  set downstreamProtocol (value) {
    ...
    this.protoConverter.downstreamProtocol = value;
  }
  ...
  async proxyCommand (url, method, body = null) {
    ...
    return await this.protoConverter.convertAndProxy(commandName, url, method, body);
  }
