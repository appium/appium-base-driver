...
function parseCapabilities (capabilities, alwaysMatch, firstMatch = [], constraints = {}) {
  let capabilitiesRequest, requiredCapabilities, allFirstMatchCapabilities, validatedFirstMatchCapabilities;
  ...
  return {capabilitiesRequest, requiredCapabilities, allFirstMatchCapabilities, validatedFirstMatchCapabilities};
}
...
export default { configureApp, downloadApp, downloadFile, copyLocalZip,
                 ...
                 parseCapabilities, validateCapabilities };
