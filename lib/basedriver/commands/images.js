...
commands.compareImages = async function (mode, firstImageData, secondImageData, options = {}) {
  const img1 = Buffer.from(firstImageData, 'base64');
  const img2 = Buffer.from(secondImageData, 'base64');
