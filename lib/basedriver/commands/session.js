...
// TODO: rmeove jsonwpDesiredCapabilities and jsonwpRequiredCaps
commands.createSession = async function createSession (jsonwpDesiredCapabilities, jsonwpRequiredCaps, w3cCapabilities) {
  ...
  if (!w3cCapabilities) {
    throw new errors.SessionNotCreatedError('Support only W3C capabilitites');
  }

  if (jsonwpDesiredCapabilities) {
    log.warn('Appium ignores the given MJSONWP desired capabilities');
  }
